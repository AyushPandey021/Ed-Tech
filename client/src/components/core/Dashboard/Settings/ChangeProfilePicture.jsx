       ...
       <div>
        ...
        <h2 className='lg:text-lg text-md font-semibold text-richblack-5 uppercase tracking-wider'>Change Profile Picture</h2>
          <div className="flex gap-x-3">
            ...
            <button onClick={handleClick} disabled={loading} className={`bg-richblack-600 text-richblack-50 lg:py-2 py-1 lg:px-5 px-2 font-semibold rounded-md uppercase tracking-wider  ${loading ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
                Select
            </button>
